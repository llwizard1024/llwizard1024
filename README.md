...
Я **Богдан** — разработчик, который любит копать вглубь: от **низкоуровневого C++** (epoll, сокеты, Linux) до **бэкенда на Java** (Spring Boot, REST API).

Сейчас в фокусе — системное программирование и построение надёжных серверных приложений. Каждый проект — это шаг по дороге к пониманию того, *как всё устроено под капотом*.
